...
btn9 = Button(window, image=btn_pic9, borderwidth=0)
...
btn8 = Button(window, image=btn_pic8, borderwidth=0)
...
btn7 = Button(window, image=btn_pic7, borderwidth=0)
...
btn0 = Button(window, image=btn_pic0, borderwidth=0)
...
btn4 = Button(window, image=btn_pic4, borderwidth=0)
...
btn5 = Button(window, image=btn_pic5, borderwidth=0)
...
btn6 = Button(window, image=btn_pic6, borderwidth=0)
...
btn_sub = Button(window, image=btn_pic_sub, borderwidth=0)
...
btn1 = Button(window, image=btn_pic1, borderwidth=0)
...
btn2 = Button(window, image=btn_pic2, borderwidth=0)
...
btn3 = Button(window, image=btn_pic3, borderwidth=0)
...
btn_add = Button(window, image=btn_pic_add, borderwidth=0)
...
btn_clear = Button(window, image=btn_pic_clear, borderwidth=0)
...
btn_div = Button(window, image=btn_pic_div, borderwidth=0)
...
btn_mul = Button(window, image=btn_pic_mul, borderwidth=0)
...
btn_equals = Button(window, image=btn_pic_equals, borderwidth=0)
